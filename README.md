...
5. **Commands**
   - **Note:** these commands should be run in a terminal windown from the root of the project.
   - `make run` - start api
   ...
   - `make destroy` - cleans all unused docker containers from your machine. This should only be used free up memory.
6. **Whats Provided**
